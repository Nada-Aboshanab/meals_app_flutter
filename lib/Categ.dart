...
Categ categFromJson(String str) => Categ.fromJson(json.decode(str));
String categToJson(Categ data) => json.encode(data.toJson());
class Categ {
  Categ({
...
Categ copyWith({  List<Categories>? categories,
}) => Categ(  categories: categories ?? _categories,
);
...
Categories copyWith({  String? idCategory,
  ...
  String? strCategoryThumb,
  String? strCategoryDescription,
}) => Categories(  idCategory: idCategory ?? _idCategory,
