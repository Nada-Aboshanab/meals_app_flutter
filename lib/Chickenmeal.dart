...
class Chickenmeal {
  ...
  Chickenmeal.fromJson(dynamic json) {
    if (json['meals'] != null) {
      _meals = [];
  ...
  List<Meals>? _meals;
Chickenmeal copyWith({  List<Meals>? meals,
}) => Chickenmeal(  meals: meals ?? _meals,
);
