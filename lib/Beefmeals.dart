...
//
// Beefmeals beefmealsFromJson(String str) => Beefmeals.fromJson(json.decode(str));
// String beefmealsToJson(Beefmeals data) => json.encode(data.toJson());
// class Beefmeals {
//   Beefmeals({
//       List<Meals>? meals,}){
//     _meals = meals;
// }
//
//   Beefmeals.fromJson(dynamic json) {
//     if (json['meals'] != null) {
//       _meals = [];
...
//   }
//   List<Meals>? _meals;
// Beefmeals copyWith({  List<Meals>? meals,
// }) => Beefmeals(  meals: meals ?? _meals,
// );
